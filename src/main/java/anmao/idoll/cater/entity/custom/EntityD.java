...
public class EntityD extends Monster implements IAnimatable {
    ...
    public EntityD(EntityType<? extends Monster> p_33002_, Level p_33003_) {
    ...
    protected void registerGoals() {
        ...
        //this.targetSelector.addGoal(2, new EntityD.VexCopyOwnerTargetGoal(this));
    ...
    private <E extends EntityD> PlayState predicate(final AnimationEvent<E> event){
        if (event.isMoving()){
    ...
    private <T extends EntityD> PlayState attackPredicate(final AnimationEvent<T> event) {
